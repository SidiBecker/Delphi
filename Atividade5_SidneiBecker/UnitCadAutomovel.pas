...
procedure TfrmCadAutomovel.btnCancelarClick(Sender: TObject);
begin

edtCodAutomovel.Clear;
...
begin
If Application.MessageBox('Tem Certeza de que deseja fechar o cadastro de veículo?',
