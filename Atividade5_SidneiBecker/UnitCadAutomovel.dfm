object frmCadAutomovel: TfrmCadAutomovel
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Autom'#243'veis'
  ClientHeight = 361
  ClientWidth = 514
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lblCodAutomovel: TLabel
    Left = 16
    Top = 16
    Width = 102
    Height = 13
    Caption = 'C'#243'digo do Autom'#243'vel'
  end
  ...
  object grpbxDonoAnterior: TGroupBox
    Left = 8
    Top = 174
    Width = 498
    Height = 123
    Caption = 'Propriet'#225'rio Anterior'
    TabOrder = 6
